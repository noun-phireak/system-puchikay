...
import { ViewCategoryDialogComponent } from './view/component'; 
...
export class ListingComponent implements OnInit
{
    ...
    viewCategory(row:any = null):void {

      const dialogRef = this._dialog.open(ViewCategoryDialogComponent, { data:{row:row, types: this.types }});
      dialogRef.afterClosed().subscribe((result) => {
